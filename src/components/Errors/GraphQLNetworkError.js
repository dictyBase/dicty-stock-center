...
/**
 * GraphQLNetworkError is the UI display for when there is a network error.
 */

const GraphQLNetworkError = ({ classes }: Props) => (
...
export default withStyles(styles)(GraphQLNetworkError)

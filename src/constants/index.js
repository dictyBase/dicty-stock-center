...
const types = {
    ...
    SEARCH_STRAINS_REQUEST: 'SEARCH_STRAINS_REQUEST',
    SEARCH_STRAINS_SUCCESS: 'SEARCH_STRAINS_SUCCESS',
    SEARCH_STRAINS_FAILURE: 'SEARCH_STRAINS_FAILURE',
    CLEAR_STRAIN_SEARCH: 'CLEAR_STRAIN_SEARCH'
}
